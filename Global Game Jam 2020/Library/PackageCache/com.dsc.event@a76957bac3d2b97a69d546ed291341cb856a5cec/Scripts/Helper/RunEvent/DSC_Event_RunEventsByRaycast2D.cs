...
{
    public class DSC_Event_RunEventsByRaycast2D : BaseRunEventByRaycast
    {
        #region Variable
...
#pragma warning disable 0649
        ...
        [SerializeField] protected Vector2 m_vDirection;
        [Min(0)]
...
#pragma warning restore 0649
        ...
        protected RaycastHit2D[] rayHitArray
        {
            get
            {
                if (m_arrRayHit == null)
                    m_arrRayHit = new RaycastHit2D[m_nCheckArraySize];
        ...
        protected RaycastHit2D[] m_arrRayHit;
        ...
        public override void CheckRaycast()
        {
            ...
            int nHit = Physics2D.RaycastNonAlloc(vPos, m_vDirection, rayHitArray, m_fDistance, m_eCheckLayer);
        ...
        void ShowGizmos()
        {
            ...
            Vector2 vDestination = vPos + m_vDirection * m_fDistance;
