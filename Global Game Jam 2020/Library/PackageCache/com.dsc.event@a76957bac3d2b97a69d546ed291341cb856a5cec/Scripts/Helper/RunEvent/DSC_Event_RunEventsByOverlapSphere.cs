...
{
    public class DSC_Event_RunEventsByOverlapSphere : BaseRunEventByOverlap
    {
        #region Variable
...
#pragma warning restore 0649
        ...
        public override void CheckOverlap()
        {
            ...
            int nHit = Physics.OverlapSphereNonAlloc(vPos, m_fRadius,hitColArray, m_eCheckLayer);
        ...
        void ShowGizmos()
        {
            ...
            Gizmos.DrawWireSphere(vPos, m_fRadius);
        }
