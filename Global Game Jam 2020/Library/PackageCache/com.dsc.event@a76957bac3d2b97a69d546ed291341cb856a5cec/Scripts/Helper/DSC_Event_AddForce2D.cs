...
{
    public class DSC_Event_AddForce2D : MonoBehaviour
    {
        #region Variable
...
#pragma warning disable 0649
        ...
        [SerializeField] protected Rigidbody2D m_hTarget;
...
#pragma warning restore 0649
        ...
        public Rigidbody2D target
        {
            ...
            {
                if (m_hTarget == null)
                    m_hTarget = GetComponent<Rigidbody2D>();
        ...
        public void SetTarget(GameObject hTarget)
        {
            ...
            m_hTarget = hTarget.GetComponent<Rigidbody2D>();
        }
